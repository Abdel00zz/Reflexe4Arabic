...
export const scrambleQuestions: ScrambleQuestion[] = [
  ...
  { id: 41, word: 'عُصْفُورٌ', scrambledLetters: ['رٌ', 'فُو', 'عُ', 'صْ'], hint: 'طَائِرٌ صَغِيرٌ يُغَرِّدُ' },
  { id: 42, word: 'بُرْتُقَالٌ', scrambledLetters: ['لٌ', 'قَا', 'بُ', 'تُ', 'رْ'], hint: 'فَاكِهَةٌ شِتَوِيَّةٌ' }
];

// Data for "Sentence Builder" exercise. (Revised for clarity and to prevent ambiguity)
export const sentenceQuestions: SentenceQuestion[] = [
  { id: 1, correctSentence: 'الْكُرَةُ تَحْتَ الْكُرْسِيِّ', scrambledWords: ['الْكُرْسِيِّ', 'تَحْتَ', 'الْكُرَةُ'] },
  { id: 2, correctSentence: 'هَذَا كِتَابٌ جَدِيدٌ', scrambledWords: ['جَدِيدٌ', 'كِتَابٌ', 'هَذَا'] },
  { id: 3, correctSentence: 'أَنَا أُحِبُّ أُمِّي وَأَبِي', scrambledWords: ['وَأَبِي', 'أُمِّي', 'أَنَا', 'أُحِبُّ'] },
  { id: 4, correctSentence: 'الْقَلَمُ فَوْقَ الطَّاوِلَةِ', scrambledWords: ['الطَّاوِلَةِ', 'فَوْقَ', 'الْقَلَمُ'] },
  { id: 5, correctSentence: 'لَوْنُ السَّمَاءِ أَزْرَقُ', scrambledWords: ['أَزْرَقُ', 'لَوْنُ', 'السَّمَاءِ'] },
  { id: 6, correctSentence: 'الْفِيلُ حَيَوَانٌ ضَخْمٌ', scrambledWords: ['ضَخْمٌ', 'حَيَوَانٌ', 'الْفِيلُ'] },
  { id: 7, correctSentence: 'الْعُصْفُورُ دَاخِلَ الْقَفَصِ', scrambledWords: ['الْقَفَصِ', 'دَاخِلَ', 'الْعُصْفُورُ'] },
  { id: 8, correctSentence: 'أُحِبُّ أَكْلَ الْفَوَاكِهِ الطَّازَجَةِ', scrambledWords: ['الطَّازَجَةِ', 'الْفَوَاكِهِ', 'أَكْلَ', 'أُحِبُّ'] },
  { id: 9, correctSentence: 'الْبَابُ الْكَبِيرُ مَفْتُوحٌ', scrambledWords: ['مَفْتُوحٌ', 'الْكَبِيرُ', 'الْبَابُ'] },
  { id: 10, correctSentence: 'أَنَا تِلْمِيذٌ فِي الصَّفِّ الْأَوَّلِ', scrambledWords: ['الْأَوَّلِ', 'الصَّفِّ', 'فِي', 'تِلْمِيذٌ', 'أَنَا'] },
  ...
  { id: 13, correctSentence: 'الْمُعَلِّمُ يَشْرَحُ الدَّرْسَ بِوُضُوحٍ', scrambledWords: ['بِوُضُوحٍ', 'الدَّرْسَ', 'يَشْرَحُ', 'الْمُعَلِّمُ'] },
  ...
  { id: 16, correctSentence: 'النَّحْلَةُ تَصْنَعُ الْعَسَلَ اللَّذِيذَ', scrambledWords: ['اللَّذِيذَ', 'الْعَسَلَ', 'تَصْنَعُ', 'النَّحْلَةُ'] },
  { id: 17, correctSentence: 'الشُّرْطِيُّ يُنَظِّمُ حَرَكَةَ الْمُرُورِ', scrambledWords: ['الْمُرُورِ', 'حَرَكَةَ', 'يُنَظِّمُ', 'الشُّرْطِيُّ'] },
  { id: 18, correctSentence: 'أَنَا أُرَتِّبُ غُرْفَتِي كُلَّ صَبَاحٍ', scrambledWords: ['صَبَاحٍ', 'كُلَّ', 'غُرْفَتِي', 'أُرَتِّبُ', 'أَنَا'] },
  { id: 19, correctSentence: 'الْأَرْنَبُ يَأْكُلُ الْجَزَرَ بِشَرَاهَةٍ', scrambledWords: ['بِشَرَاهَةٍ', 'الْجَزَرَ', 'يَأْكُلُ', 'الْأَرْنَبُ'] },
  { id: 20, correctSentence: 'نَحْنُ نُحِبُّ وَطَنَنَا الْعَزِيزَ', scrambledWords: ['الْعَزِيزَ', 'وَطَنَنَا', 'نُحِبُّ', 'نَحْنُ'] },
  { id: 21, correctSentence: 'الطَّبِيبُ يُعَالِجُ الْمَرْضَى فِي الْمُسْتَشْفَى', scrambledWords: ['الْمُسْتَشْفَى', 'فِي', 'الْمَرْضَى', 'يُعَالِجُ', 'الطَّبِيبُ'] },
  { id: 22, correctSentence: 'أَنَا أَسْتَيْقِظُ مِنَ النَّوْمِ بَاكِرًا', scrambledWords: ['بَاكِرًا', 'النَّوْمِ', 'مِنَ', 'أَسْتَيْقِظُ', 'أَنَا'] },
  { id: 23, correctSentence: 'الْفَلَّاحُ يَزْرَعُ الْقَمْحَ فِي الْحَقْلِ', scrambledWords: ['الْحَقْلِ', 'فِي', 'الْقَمْحَ', 'يَزْرَعُ', 'الْفَلَّاحُ'] },
  { id: 24, correctSentence: 'الْجَوُّ مُشْمِسٌ وَجَمِيلٌ الْيَوْمَ', scrambledWords: ['الْيَوْمَ', 'وَجَمِيلٌ', 'مُشْمِسٌ', 'الْجَوُّ'] },
  { id: 25, correctSentence: 'أَنَا أَسْمَعُ كَلَامَ وَالِدَيَّ بِاهْتِمَامٍ', scrambledWords: ['بِاهْتِمَامٍ', 'وَالِدَيَّ', 'كَلَامَ', 'أَسْمَعُ', 'أَنَا'] },
  { id: 26, correctSentence: 'الْوَرْدَةُ الْحَمْرَاءُ رَائِحَتُهَا جَمِيلَةٌ', scrambledWords: ['جَمِيلَةٌ', 'رَائِحَتُهَا', 'الْحَمْرَاءُ', 'الْوَرْدَةُ'] },
  { id: 27, correctSentence: 'الْقِطَارُ الْجَدِيدُ سَرِيعٌ جِدًّا', scrambledWords: ['جِدًّا', 'سَرِيعٌ', 'الْجَدِيدُ', 'الْقِطَارُ'] },
  { id: 28, correctSentence: 'نَحْنُ نَتَنَاوَلُ طَعَامَ الْغَدَاءِ مَعًا', scrambledWords: ['مَعًا', 'الْغَدَاءِ', 'طَعَامَ', 'نَتَنَاوَلُ', 'نَحْنُ'] },
  { id: 29, correctSentence: 'أَنَا أَغْسِلُ أَسْنَانِي بِالْفُرْشَاةِ وَالْمَعْجُونِ', scrambledWords: ['وَالْمَعْجُونِ', 'بِالْفُرْشَاةِ', 'أَسْنَانِي', 'أَغْسِلُ', 'أَنَا'] },
  { id: 30, correctSentence: 'الْخَبَّازُ يَصْنَعُ الْخُبْزَ الطَّازَجَ', scrambledWords: ['الطَّازَجَ', 'الْخُبْزَ', 'يَصْنَعُ', 'الْخَبَّازُ'] },
  { id: 31, correctSentence: 'نَحْنُ نَرَى الْأَشْيَاءَ بِأَعْيُنِنَا', scrambledWords: ['بِأَعْيُنِنَا', 'الْأَشْيَاءَ', 'نَرَى', 'نَحْنُ'] },
  { id: 32, correctSentence: 'الشَّمْسُ هِيَ مَصْدَرُ الضَّوْءِ', scrambledWords: ['الضَّوْءِ', 'مَصْدَرُ', 'هِيَ', 'الشَّمْسُ'] },
  { id: 33, correctSentence: 'أَنَا أُطِيعُ وَالِدَيَّ دَائِمًا', scrambledWords: ['دَائِمًا', 'وَالِدَيَّ', 'أُطِيعُ', 'أَنَا'] },
  { id: 34, correctSentence: 'الصِّدْقُ صِفَةٌ حَسَنَةٌ', scrambledWords: ['حَسَنَةٌ', 'صِفَةٌ', 'الصِّدْقُ'] },
  { id: 35, correctSentence: 'الرِّيَاضَةُ مُفِيدَةٌ لِصِحَّةِ الْجِسْمِ', scrambledWords: ['الْجِسْمِ', 'لِصِحَّةِ', 'مُفِيدَةٌ', 'الرِّيَاضَةُ'] },
  ...
  { id: 37, correctSentence: 'يَنْزِلُ الْمَطَرُ مِنَ السَّمَاءِ شِتَاءً', scrambledWords: ['شِتَاءً', 'السَّمَاءِ', 'مِنَ', 'الْمَطَرُ', 'يَنْزِلُ'] },
  { id: 38, correctSentence: 'الْكِتَابُ هُوَ أَفْضَلُ صَدِيقٍ', scrambledWords: ['صَدِيقٍ', 'أَفْضَلُ', 'هُوَ', 'الْكِتَابُ'] },
  { id: 39, correctSentence: 'أُحِبُّ اللَّعِبَ مَعَ أَصْدِقَائِي فِي الْمَلْعَبِ', scrambledWords: ['الْمَلْعَبِ', 'فِي', 'أَصْدِقَائِي', 'مَعَ', 'اللَّعِبَ', 'أُحِبُّ'] },
  { id: 40, correctSentence: 'الْأَزْهَارُ تَتَفَتَّحُ فِي الرَّبِيعِ', scrambledWords: ['الرَّبِيعِ', 'فِي', 'تَتَفَتَّحُ', 'الْأَزْهَارُ'] },
  { id: 41, correctSentence: 'الْعِلْمُ نُورٌ وَالْجَهْلُ ظَلَامٌ', scrambledWords: ['ظَلَامٌ', 'وَالْجَهْلُ', 'نُورٌ', 'الْعِلْمُ'] },
  { id: 42, correctSentence: 'أَنَا أَشْرَبُ الْعَصِيرَ بَعْدَ اللَّعِبِ', scrambledWords: ['اللَّعِبِ', 'بَعْدَ', 'الْعَصِيرَ', 'أَشْرَبُ', 'أَنَا'] }
];
